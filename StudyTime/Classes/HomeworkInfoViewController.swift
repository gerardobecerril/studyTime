...
//  StudyTime
//
//  Created by Gerardo Becerril on 11/7/18.
//  Copyright © 2018 Gerardo Glz. All rights reserved.
//

import UIKit

class HomeworkInfoViewController: UIViewController, UITextFieldDelegate, UITextViewDelegate {
...
extension HomeworkInfoViewController: UIPickerViewDelegate, UIPickerViewDataSource {
